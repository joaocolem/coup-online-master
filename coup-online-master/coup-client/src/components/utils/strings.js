...
const LanguageStrings = () => {
  ...
  const strings = {
    en: {
      ...
      welcomeMessage: "Welcome to Ruse!",
      ...
      action: "Action",
      effect: "Effect",
      counteration: "Counteraction",
      collectCoin: "Collect 1 coin",
      collect2Coins: "Collect 2 coins",
      pay7: "Pay 7 coins",
      makeLoseInfluence: "Make any player lose influence",
      collect3Coins: "Collect 3 coins",
      pay3: "Pay 3 coins",
      draw2: "Draw 2 influences and put 2 back",
      draw2cfa: "Draw 2 coins from another player",
    ...
    pt: {
      ...
      welcomeMessage: "Bem-vindo ao Ruse!",
      ...
      cheatSheet: "Carta de Dicas",
      influences: "Influências",
      action: "Ação",
      effect: "Efeito",
      counteration: "Contramedida",
      collectCoin: "Coletar 1 moeda",
      collect2Coins: "Coletar 2 moedas",
      pay7: "Pagar 7 moedas",
      makeLoseInfluence: "Fazer qualquer jogador perder influência",
      collect3Coins: "Coletar 3 moedas",
      pay3: "Pagar 3 moedas",
      draw2: "Comprar 2 influências e colocar 2 de volta",
      draw2cfa: "Comprar 2 moedas de outro jogador"
    },
  };
